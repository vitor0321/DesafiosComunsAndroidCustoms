package com.example.desafioscomunsandroidcustoms.presentation.ui.fragment.mvp.concrete_presenter

import com.example.desafioscomunsandroidcustoms.R
import com.example.desafioscomunsandroidcustoms.presentation.ui.fragment.mvp.base_alert.AlertAction
import com.example.desafioscomunsandroidcustoms.presentation.ui.fragment.mvp.base_alert.AlertContent
...
class MyViewPresenter : MyViewContract.Presenter {
    ...
    override fun computeMaxValue(aValue: String, bValue: String): String {
        ...
        if(result in 0..5) pView?.showAlert(AlertType.SmallScreenSuccess(AlertContent(
            title = R.string.feedbak_rating_title
        ), AlertAction()))
