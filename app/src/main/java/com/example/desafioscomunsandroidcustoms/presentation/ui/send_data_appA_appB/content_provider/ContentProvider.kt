package com.example.desafioscomunsandroidcustoms.presentation.ui.send_data_appA_appB.content_provider
...
class AppInfoProvider : ContentProvider() {
    ...
    companion object {
        ...
        private const val PROVIDER_TYPE =
            "vnd.android.cursor.item/vnd.$AUTHORITY/$COLUMN_ACCOUNT_STATUS"
    ...
    override fun query(
        ...
        matrixCursor.addRow(
            arrayOf<Any>(
                1,
                PROVIDER_VERSION,
                "active"// EX: AQUI VOCE PEGARIA ALGO DE SETTINGS sharedPreferences
            )
        )
        return matrixCursor
    }
